jQuery(document).ready(function(){
	...
	jQuery('.front .menuabout').attr("href","#sec5");

	
	jQuery('.front .menucap').attr("href","#sec2");
	
	jQuery('.front .menuservice').attr("href","#sec4");

	jQuery('.front .menuhelp').attr("href","#rfid");

	jQuery('.front .menucontact').attr("href","#conta");
